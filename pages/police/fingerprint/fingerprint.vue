    ...
    <div class="fingerprint-wrapper">
      ...
      <div class="fingerprint-box">
        <div class="fingerprint-list" v-for="(item, index) in policeFingerList" :key="index">
          <div class="fingerprint-item" :class="{ disabledClick: !!item.mKey && !!item.mKey2 }" @click="handleCheckChange(item, index)">
            <checkbox class="checkbox" :checked="!!item.mKey && !!item.mKey2 ? true : item.policeNumber == checkedId ? true : false" :disabled="!!item.mKey && !!item.mKey2" :class="{ disabledCheck: !!item.mKey && !!item.mKey2 }">
