    ...
    <view class="recognition-dialogs-container">
      ...
      <view class="uni-flex uni-flex-item uni-column" style="justify-content: space-around; align-items: center">
        ...
        <template v-if="isFaceRecognition">
          ...
          <text v-if="useFor == 'outroom'" style="font-size: 20.83upx; font-weight: 400; color: #35fffa">{{ regConfig.regName }}</text>
...
export default {
  ...
  computed: {
    ...
    regTitle () {
      return this.isFaceRecognition ? "人脸认证" : "指纹认证";
    },
    // 1:1人脸验证 or 1：N人脸验证
    useFace11 () {
